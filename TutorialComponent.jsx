  ...
  return(
    ...
    <div>
      ...
      <div className="TutorialFooter">
				<div className="TutorialFooterContent">
					<h1>Follow Us on Social Media</h1>
					<div className="TutorialSocialImg"><img style ={{width: 40, height: 40}}img src={LinkedinLogo} alt="Redback LinkedIn" /> <p>LinkedIn</p></div>
                	<div className="TutorialSocialImg"><img style ={{width: 40, height: 40}}img src={instagramLogo} alt="Redback Instagram" /> <p>Instagram</p></div>
                	<div className="TutorialSocialImg"><img style ={{width: 40, height: 40}}img src={twitterLogo} alt="Redback Twitter" /> <p>Twitter</p></div>
